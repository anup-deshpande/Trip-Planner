...
public class item_in_trip implements Serializable {
    ...
    public ArrayList<com.example.AnupDeshpande.homework8.places_to_visit> getPlaces_to_visit() {
        return places_to_visit;
    }

    public void setPlaces_to_visit(ArrayList<com.example.AnupDeshpande.homework8.places_to_visit> places_to_visit) {
